...
const Nutrition = () => {
  return (
    <div className="bg-white p-4 w-full col-span-12 lg:col-span-4 xl:col-span-3 order-1 border rounded-lg min-h-[300px] lg:min-h-[500px] flex flex-col justify-between">
  ...
  <Link href="/management/identitas-balita/detail-anak/diary-anak/log-nutrisi">
